...
class TicketAttachment(models.Model):
    ...
    def __str__(self):
        return f"Attachment {self.filename} for Ticket #{self.ticket.id}"
...
# Keep Comment for backwards compatibility with forms/views until we update them all
class Comment(models.Model):
    ticket = models.ForeignKey(Ticket, on_delete=models.CASCADE, related_name='legacy_comments')
